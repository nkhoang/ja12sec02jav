package com.nkhoang.webapp.helper;
...
public class PaginatedListImpl implements ExtendedPaginatedList {
     ...
     */
    public PaginatedListImpl(HttpServletRequest request, List<User> users, int pageSize) {
    ...
    public ExtendedPaginatedList getPaginatedListObject(int pageSize)
        ...
        return new PaginatedListImpl(request, users, pageSize);
    }
