               ...
               for (Element child : definitionChildEles) {
                  ...
                  if (checkElementName(child, "h3") &&
                     ...
                     if (w.getKindidmap().get(kind) == null) {
                        WebUtils.sendMail(
                              String.format("Hi Boss, " +
                                    "<br /> " +
                                    "<p>I just found a new word kind : <b>[%s]</b> of the word <b>%s</b>." +
                                    "Please help me add it to our lookup list.</p>", kind, word.toLowerCase()),
                              mailSender, "New Word Kind", "nkhoang.it@gmail.com");
                        continue;
                     }
