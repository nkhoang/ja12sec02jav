...
public class UserAction {
	...
	@RequestMapping("/dictionary/addDictionary")
	public ModelAndView addDictionary(
		@RequestParam(required = true, defaultValue = "") String dictName,
		@RequestParam(required = true, defaultValue = "") String dictDescription) {
