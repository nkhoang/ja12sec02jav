...
<div class="content">
    <div id="item_board">
        ...
        <div id="item_controller">
            <a title="Add Item" class="showItemForm" href="<?php echo CController::createUrl('/item/ajaxCreateItem', array('category_id' => $category->id)); ?>"> <img src="<?php echo Yii::app()->request->baseUrl . '/images/add.png'; ?>" width="32" height="32" /></a>
            <a title="Delete Items" href="javascript:handleDeleteItems()"> <img src="<?php echo Yii::app()->request->baseUrl . '/images/delete.png'; ?>" width="32" height="32" /></a>
        </div>
        <div id="items_c">
