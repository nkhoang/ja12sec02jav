        ...
        $(this).each(function(){
            ...
            $(this).load(function(){
                if (img.hasInit) {
                    ...
                    var over_img = false;
                    var divSelectorFirst = 'div.' + o.className + ':first';
                    var divSelectorLast = 'div.' + o.className + ':last';
                    var caption = $(divSelectorFirst, $(this).parents('div.thumbnail'));
                    var captionContent = $(divSelectorLast, $(this).parents('div.thumbnail'));
                    ...
                    $('div.caption-wrapper div').hover(function(){
                        over_caption = true;
                    }, function(){
                        over_caption = false;
                        window.setTimeout(cHide, o.hideDelay);
                ...
                if (o.position == 'bottom') {
                    var vLabelOffset = parseInt(caption.css('border-top-width').replace('px', '')) +
                    parseInt(captionContent.css('padding-top').replace('px', '')) -
                    1;
