package com.nkhoang.common.lucene.util;
...
public class LuceneUtils {
	 ...
	 *
	 * @param query        Lucene query to parse
	 * @param defaultField name of the default field for query terms
	 * @param analyzer     Analyzer to use when parsing
	 *
	...
	public static Query parseQuery(
		String query, String defaultField, Analyzer analyzer) throws ParseException {
		QueryParser parser = new QueryParser(
			Version.LUCENE_CURRENT, defaultField, analyzer);
	 ...
	 *          thrown if parsing fails
	 */
	public static Query parseQuery(String query, Analyzer analyzer) throws ParseException {
	 ...
	 * @param excludeEscapeStr array of characters not to escape
	 *
	...
	public static String escapeSearchText(String text, String... excludeEscapeStr) {
		...
		Set<String> luceneReservedToEscape = new HashSet<String>(
			Arrays.asList(LUCENE_RESERVED_CHARS));
		...
		String reservedCharRegx = "\\Q" + StringUtils.join(luceneReservedToEscape.toArray(), "\\E|\\Q") + "\\E";
